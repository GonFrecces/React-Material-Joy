    ...
    <CssVarsProvider disableTransitionOnChange>
      ...
      <Box component="main"
        ...
        <Box component="section" sx={{ p: 2, border: '1px dashed grey', textAlign: 'center' }}>
          <Typography level="title-lg">Componentes JoyUI</Typography>
          <Typography level="body-sm">{date.toString('dd/mm/yyyy')}</Typography>
        </Box>
        <Grid
          container
          spacing={{ xs: 2, md: 3 }}
        ...
        >
          <Grid key={`login`} size={{ xs: 2, sm: 4, md: 4 }}>
            <Card sx={(theme) => ({ width: 320, maxWidth: '100%', boxShadow: 'lg', transition: 'transform 0.3s, border 0.3s',
              '&:hover': {
